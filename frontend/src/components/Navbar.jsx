import { HiOutlineUser,HiOutlineHeart, HiOutlineShoppingCart } from "react-icons/hi2";
                ...
                <div>
                    {
                        ...
                        <button onClick={()=> setIsDropdownOpen(!isDropdownOpen)}>
                            <img src={avatar} alt="avatar" className={ `size-7 rounded-full ${currentuser ? 'ring-2 ring-blue-500':''}`}  />
                        </button>
                        {/* show dropdown*/}
                        {
                            isDropdownOpen && (
